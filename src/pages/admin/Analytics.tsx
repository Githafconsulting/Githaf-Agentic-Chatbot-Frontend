...
import { MessageSquare, Users, ThumbsUp, TrendingUp, Database, Sparkles, AlertCircle, GripVertical, Layout as LayoutIcon, Save, RotateCcw, ChevronDown, CheckCircle, BarChart3, Clock, Timer } from 'lucide-react';
...
const defaultLayout = [
  ...
  { i: 'world-map', x: 0, y: 9, w: 6, h: 9, minW: 4, minH: 8 },      // 720px min for globe + controls
...
export const AnalyticsPage: React.FC = () => {
  ...
  const stats = [
    ...
    {
      label: 'Avg Duration',
      value: formatDuration(analytics?.conversation_metrics?.avg_conversation_duration_seconds || 0),
      icon: Clock,
